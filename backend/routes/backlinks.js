...
router.post('/submit/live', verifyAdminToken, async (req, res) => {
  try {
    ...
    const result = await platformIntegrations.post(platform, {
      ...
      link: link || process.env.SITE_URL || 'https://skytravelfare.com',
      imageUrl,
      subreddit,
