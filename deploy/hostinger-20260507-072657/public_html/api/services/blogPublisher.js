...
class BlogPublisherService {
  ...
  async publishToMedium(blogPost) {
    ...
    const response = await axios.post(
      `https://api.medium.com/v1/users/${userId}/posts`,
      {
        ...
        canonicalUrl: `https://skytravelfare.com/blog/${blogPost.slug}`
      },
      {
        headers: {
    ...
    const response = await axios.post(
      'https://dev.to/api/articles',
      {
        article: {
          ...
          canonical_url: `https://skytravelfare.com/blog/${blogPost.slug}`,
  ...
  convertToMediumFormat(content) {
    ...
    return content + '\n\n---\n\n*Originally published at [skytravelfare.com](https://skytravelfare.com)*';
  }
        ...
        platforms: [
          {
            ...
            instructions: 'Copy content and paste. Add canonical URL to skytravelfare.com',
            canonicalUrl: `https://skytravelfare.com/blog/${blogPost.slug}`
          },
          {
            name: 'Dev.to',
          ...
          },
          {
            ...
            instructions: 'Write article, paste content, link back to skytravelfare.com'
          },
          {
            name: 'Hashnode',
            da: 88,
