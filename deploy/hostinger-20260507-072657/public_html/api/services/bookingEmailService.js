...
class BookingEmailService {
  constructor() {
    this.fromEmail = process.env.EMAIL_USER || 'info@skytravelfare.com';
  ...
  async sendBookingConfirmation(bookingData) {
    ...
    try {
      const info = await this.transporter.sendMail({
        from: `"Sky Fare ✈️" <${this.fromEmail}>`,
        to: passengerEmail,
        cc: this.ccEmail,
          ...
          <tr>
            <td align="center">
              <table cellpadding="0" cellspacing="0" border="0" style="background: linear-gradient(135deg, #0ea5e9, #6366f1); padding: 20px 40px; border-radius: 20px; box-shadow: 0 12px 40px rgba(14,165,233,0.4);">
                <tr>
                  <td>
                    <p style="margin: 0; font-size: 32px; font-weight: 900; color: white; letter-spacing: -1px;">✈️ Sky Fare</p>
                  </td>
                </tr>
              </table>
            </td>
              ...
              <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="padding: 8px;">
                    <a href="https://skytravelfare.com/booking/${referenceNumber}" style="display: inline-block; background: linear-gradient(135deg, #0ea5e9, #6366f1); color: white; padding: 18px 40px; border-radius: 16px; text-decoration: none; font-weight: 800; font-size: 16px; box-shadow: 0 12px 32px rgba(14,165,233,0.4);">
                      📋 View Booking
                    </a>
                  </td>
                  <td style="padding: 8px;">
                    <a href="https://skytravelfare.com/booking/${referenceNumber}?print=1" style="display: inline-block; background: linear-gradient(135deg, #10b981, #059669); color: white; padding: 18px 40px; border-radius: 16px; text-decoration: none; font-weight: 800; font-size: 16px; box-shadow: 0 12px 32px rgba(16,185,129,0.4);">
                      🖨️ Print Ticket
                    </a>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding: 40px; text-align: center;">
                    ...
                    <p style="margin: 20px 0 0; font-size: 14px;">
                      <a href="mailto:info@skytravelfare.com" style="color: #0ea5e9; text-decoration: none;">info@skytravelfare.com</a>
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding: 24px; text-align: center;">
              <p style="margin: 0 0 16px;">
                <a href="https://skytravelfare.com" style="color: #94a3b8; text-decoration: none; margin: 0 12px; font-size: 14px;">Website</a>
                <span style="color: #475569;">•</span>
                <a href="https://skytravelfare.com/privacy" style="color: #94a3b8; text-decoration: none; margin: 0 12px; font-size: 14px;">Privacy</a>
                <span style="color: #475569;">•</span>
                <a href="https://skytravelfare.com/terms" style="color: #94a3b8; text-decoration: none; margin: 0 12px; font-size: 14px;">Terms</a>
              </p>
              <p style="margin: 0; font-size: 13px; color: #64748b;">skytravelfare.com</p>
              <p style="margin: 6px 0; font-size: 12px; color: #475569;">1309 Coffeen Ave STE 1200, Sheridan, WY 82801, USA</p>
              <p style="margin: 16px 0 0; font-size: 12px; color: #475569;">© ${new Date().getFullYear()} Sky Fare. All rights reserved.</p>
            </td>
          </tr>
        </table>
