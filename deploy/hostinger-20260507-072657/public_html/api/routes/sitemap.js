...
router.get('/sitemap.xml', (req, res) => {
  ...
  const baseUrl = process.env.SITE_URL || 'https://skytravelfare.com';
...
<head>
  ...
  <title>Sitemap - skytravelfare.com</title>
  <style>
...
<body>
  <div class="container">
    <h1>🗺️ Site Map</h1>
    <p class="subtitle">Complete navigation of skytravelfare.com</p>
