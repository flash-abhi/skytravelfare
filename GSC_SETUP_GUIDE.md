...
This guide will help you set up **live Google Search Console (GSC)** integration for skytravelfare.com. Once configured, you'll get **real-time data** from Google Search Console directly in your admin dashboard.
...
3. Enter your website: `https://skytravelfare.com`
...
4. **Add Authorized Redirect URIs**
   ...
   **For Production (VPS):**
   ```
   https://skytravelfare.com/api/gsc/oauth2callback
...
2. **Add Google Credentials**
   ...
   GSC_SITE_URL=https://skytravelfare.com
...
3. **For Production VPS, use production URL:**
   ```env
   GOOGLE_REDIRECT_URI=https://skytravelfare.com/api/gsc/oauth2callback
   ```
...
3. Check that the site URL in GSC matches exactly: `https://skytravelfare.com`
...
2. **Add Production URI to Google Cloud**
   ...
   - Add `https://skytravelfare.com/api/gsc/oauth2callback`
...
**4. Test Connection:**
- Go to: https://skytravelfare.com/admin/dashboard
- Click SEO tab
